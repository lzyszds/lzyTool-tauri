...
<template>
  <div class="preloader" style="opacity: 1;"> <svg version="1.1" id="sun" xmlns="http://www.w3.org/2000/svg"
    ...
    </svg> <svg version="1.1" id="cloud" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div class="rain"> <span class="drop"></span> <span class="drop"></span> <span class="drop"></span> <span
        class="drop"></span> <span class="drop"></span> <span class="drop"></span> <span class="drop"></span> <span
        class="drop"></span> <span class="drop"></span> <span class="drop"></span> </div>
  </div>
</template>
...
#load-layout .drop:nth-child(1) {
  animation-delay: -130ms;
}

#load-layout .drop:nth-child(2) {
  animation-delay: -240ms;
}

#load-layout .drop:nth-child(3) {
  animation-delay: -390ms;
}

#load-layout .drop:nth-child(4) {
  animation-delay: -525ms;
}

#load-layout .drop:nth-child(5) {
  animation-delay: -640ms;
}

#load-layout .drop:nth-child(6) {
  animation-delay: -790ms;
}

#load-layout .drop:nth-child(7) {
  animation-delay: -900ms;
}

#load-layout .drop:nth-child(8) {
  animation-delay: -1050ms;
}

#load-layout .drop:nth-child(9) {
  animation-delay: -1130ms;
}

#load-layout .drop:nth-child(10) {
